---
id: "aspose-barcode-for-android-via-java-26-3-release-notes"
slug: "aspose-barcode-for-android-via-java-26-3-release-notes"
linktitle: "Aspose.BarCode for Android via Java 26.3"
title: "Aspose.BarCode for Android via Java 26.3"
weight: 960
description: "Aspose.BarCode for Android via Java 26.3 – the latest updates and fixes."
type: "repository"
layout: "release"
hideChildren: false
toc: false
family_listing_page_title: "Aspose.BarCode for Android via Java 26.3"
menuItemWithNoContent: false
---

{{% alert color="primary" %}} 

This page contains release notes information for [Aspose.BarCode for Android via Java 26.3](https://releases.aspose.com/barcode/androidjava/new-releases/aspose.barcode-for-android-via-java-26.3/).
...
public void example1() {
    ...
    Assert.assertEquals(codetext, results[0].getCodeText());
}
```
...
public void example2() {
    ...
    String expected = "Will犬Right狗привет犬Power狗test";
    ...
    Assert.assertEquals(1, results.length);
    Assert.assertEquals(expected, results[0].getCodeText());
}
```
